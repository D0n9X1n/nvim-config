...
map('n', '<leader>m', ':MarkdownPreview github<CR>', opts)
map('n', '<leader>t', ':TagbarToggle<CR>', opts)
map('n', '<F9>', ':TagbarToggle<CR>', opts)
map('n', '<leader>us', ':UltiSnipsEdit<CR>', opts)
map('n', '<leader>jd', ':YcmCompleter GoToDefinitionElseDeclaration<CR>', opts)
map('n', '<leader>gd', ':YcmCompleter GoToDeclaration<CR>', opts)
map('n', '<leader>ee', ':YcmDiags<CR>', opts)
