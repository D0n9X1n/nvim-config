...
map('n', '<F2>', '<cmd>CopilotChatToggle<cr>', { noremap = true, silent = true, desc = 'CopilotChat - Toggle' })
map('v', '<F2>', '<cmd>CopilotChatToggle<cr>', { noremap = true, silent = true, desc = 'CopilotChat - Toggle' })
